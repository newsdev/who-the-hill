...
def info_page():
    ...
    '''
    return render_template("index.html", number=os.environ.get('TWILIO_NUMBER', None), app_name=os.environ.get('APP_NAME', None))
...
def recongize():
    ...
    external_num = "+17276670510"
    twilio_num = "+12028582474"
